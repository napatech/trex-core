...
----
 ...
 [bash]>cd ntanl_package_3gd_linux_11.0.2
...
=== Napatech NIC driver tweaks
The following changes must be made to /opt/napatech3/config/ntservice.ini:
...
=== Advanced Statefull
In order for advanced statefull til work, promiscuous mode must be enabled by using the --prom commandline option.
