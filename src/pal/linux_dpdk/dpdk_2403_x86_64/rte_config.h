...
#define RTE_MAX_MEMSEG_LISTS 2048
#define RTE_MAX_MEMSEG_PER_LIST (8192*6)
#define RTE_MAX_MEM_MB_PER_LIST (32768*4)
#define RTE_MAX_MEMSEG_PER_TYPE (32768*4)
#define RTE_MAX_MEM_MB_PER_TYPE (65536*2)
